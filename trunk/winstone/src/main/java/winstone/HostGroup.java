...
public class HostGroup {
     ...
     * @throws IOException
     */
    public HostGroup(ClassLoader commonLibCL, File commonLibCLPaths[], Map<String,String> args) throws IOException {
        this(null, null, commonLibCL, commonLibCLPaths, args);
    }
    
    public HostGroup(Cluster cluster, ObjectPool objectPool, ClassLoader commonLibCL, File commonLibCLPaths[], Map<String,String> args) throws IOException {
        super();
        ...
        // If host mode
        if (hostDirName == null) {
            addHostConfiguration(webappsDirName, DEFAULT_HOSTNAME, cluster, objectPool, commonLibCL, commonLibCLPaths, args);
        ...
        // Otherwise multi-host mode
            ...
            initMultiHostDir(hostDirName, cluster, objectPool, commonLibCL, commonLibCLPaths, args);
     ...
     * @throws IOException
     */
    protected void addHostConfiguration(String webappsDirName, String hostname, Cluster cluster, ObjectPool objectPool, ClassLoader commonLibCL, File commonLibCLPaths[], Map<String,String> args) throws IOException {
     ...
     * @throws IOException
     */
    protected void initMultiHostDir(String hostsDirName, Cluster cluster, ObjectPool objectPool, ClassLoader commonLibCL, File commonLibCLPaths[], Map<String,String> args) throws IOException {
            ...
            for (int n = 0; n < children.length; n++) {
                ...
                if (children[n].isDirectory()) {
                    if (!this.hostConfigs.containsKey(childName)) {
                        addHostConfiguration(children[n].getCanonicalPath(), childName, cluster, objectPool, commonLibCL, commonLibCLPaths, args);
                    }
                }
