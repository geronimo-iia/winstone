...
public class WinstoneContext implements Context {
     ...
     */
    public WinstoneContext(Map<String, Object> sourceEnvironment, WinstoneContext parent, String absoluteName, Object contextLock) throws NamingException {
        this.environment = new Hashtable<String, Object>();
        List<String> sourceKeys = new ArrayList<String>(sourceEnvironment.keySet());
        for (Iterator<String> i = sourceKeys.iterator(); i.hasNext();) {
     ...
     */
    protected WinstoneContext(Map<String, Object> sourceEnvironment, WinstoneContext parent, String absoluteName, Object contextLock, Hashtable<String, Object> bindings) throws NamingException {
        this.environment = new Hashtable<String, Object>();
        List<String> sourceKeys = new ArrayList<String>(sourceEnvironment.keySet());
        for (Iterator<String> i = sourceKeys.iterator(); i.hasNext();) {
            String key = (String)i.next();
    ...
    public Hashtable<String, Object> getEnvironment() throws NamingException {
        return new Hashtable<String, Object>(this.environment);
    }
    ...
    /**
     * Lookup an object in the context. Returns a copy of this context if the name is empty, or the specified resource (if we have it). If
     * the name is unknown, throws a NameNotFoundException.
     */
    public Object lookup(Name name) throws NamingException {
        ...
        synchronized (this.contextLock) {
            ...
            // complain
                ...
                throw new NotContextException(ContainerJNDIManager.JNDI_RESOURCES.getString("WinstoneContext.NotContext", new String[] {
                    thisName.toString(), thisValue.getClass().getName()
                }));
    ...
    public NamingEnumeration list(Name name) throws NamingException {
        ...
        // Lookup the object - if it's not a context, throw an error
            ...
            if (ctx instanceof Context)
                ...
                throw new NotContextException(ContainerJNDIManager.JNDI_RESOURCES.getString("WinstoneContext.NotContext", new String[] {
                    searchName.toString(), ctx.getClass().getName()
                }));
        }
    }
    ...
    public void destroySubcontext(Name name) throws NamingException {
        ...
        // If absolutely referring to this context, tell the parent to delete this context
            ...
            if (!name.isEmpty())
                ...
                throw new NamingException(ContainerJNDIManager.JNDI_RESOURCES.getString("WinstoneContext.CantDestroyEmptyName"));
        } else if (childName.size() > 1) {
            Object ctx = lookup(childName.get(0));
            if (!(ctx instanceof Context))
                throw new NotContextException(ContainerJNDIManager.JNDI_RESOURCES.getString("WinstoneContext.NotContext", new String[] {
