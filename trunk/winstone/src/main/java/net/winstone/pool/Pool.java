...
/**
 * A Pool interface based on {@link http://en.wikipedia.org/wiki/Object_pool_pattern }.
 * 
...
public interface Pool<T> {
    ...
    /**
     * Invalidate specified resource and remove it from pool. This method should be used when an object that has been borrowed is determined
     * (due to an exception or other problem) to be invalid.
     * 
     * @param resource the specified resource.
     */
