...
/**
 * javaURLContextFactory class start with "java" and not "Java" according to jndi naming scheme:
 * <p>
 * <code>
 * prefix.schemeId.schemeIdURLContextFactory 
 * </code>
 * </p>
 * See <a>http://java.sun.com/products/jndi/tutorial/beyond/env/overview.html</a>
 * <ul>
...
public class javaURLContextFactory implements InitialContextFactory, ObjectFactory {
    ...
    public Context getInitialContext(final Hashtable<?, ?> environnement) throws NamingException {
        if (rootContext == null) {
            ...
            Context env = rootContext.createSubcontext("java:").createSubcontext("comp").createSubcontext("env");
