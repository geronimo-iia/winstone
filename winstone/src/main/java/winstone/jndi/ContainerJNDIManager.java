...
public class ContainerJNDIManager implements JNDIManager {
        ...
        try {
            ...
            for (Iterator<String> i = this.objectsToCreate.keySet().iterator(); i.hasNext();) {
                ...
                try {
                    ...
                    Logger.log(Logger.ERROR, JNDI_RESOURCES, "ContainerJNDIManager.ErrorBindingResource", name, err);
                }
            }
        ...
        try {
            ...
            for (Iterator<String> i = this.objectsToCreate.keySet().iterator(); i.hasNext();) {
                ...
                try {
                    ...
                    Logger.log(Logger.ERROR, JNDI_RESOURCES, "ContainerJNDIManager.ErrorUnbindingResource", name, err);
                }
     ...
     */
    protected Object createObject(String name, String className, String value, Map<String, String> args, ClassLoader loader) {
        ...
        try {
            ...
            if (className.equals("javax.sql.DataSource")) {
                try {
                    ...
                    Logger.log(Logger.ERROR, JNDI_RESOURCES, "ContainerJNDIManager.ErrorBuildingDatasource", name, err);
                }
            }
            ...
            // If we are working with a mail session
                ...
                try {
                    ...
                    Logger.log(Logger.ERROR, JNDI_RESOURCES, "ContainerJNDIManager.ErrorBuildingMailSession", name, err);
                }
            }
            ...
            // If unknown type, try to instantiate with the string constructor
                ...
                try {
                    ...
                    Logger.log(Logger.ERROR, JNDI_RESOURCES, "ContainerJNDIManager.ErrorBuildingObject", new String[] {
                        name, className
                    }, err);
                }
            }
