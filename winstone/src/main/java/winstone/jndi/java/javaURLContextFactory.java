    ...
    public Context getInitialContext(Hashtable<?,?> env) throws NamingException {
        synchronized (lock) {
            if (rootContext == null) {
                ...
                rootContext = new WinstoneContext((Map<String, Object>)env, null, "java:", lock);
                WinstoneContext compCtx = new WinstoneContext((Map<String, Object>)env, rootContext, "java:/comp", lock);
                WinstoneContext envCtx = new WinstoneContext((Map<String, Object>)env, compCtx, "java:/comp/env", lock);
