 ...
 */
public class WinstoneNameEnumeration implements NamingEnumeration<Object> {
    private Enumeration<NameClassPair> nameEnumeration;
    
    /**
     * Constructor
     */
    public WinstoneNameEnumeration(Map<String, Object> bindings) {
