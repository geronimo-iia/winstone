...
/**
 * MimeTypes implement a FileNameMap and using a <code>MapLoader</code> in order to load data (localized on file MimeTypes.properties).
 * MimeTypes is initialized on demand (@see http://en.wikipedia.org/wiki/Initialization_on_demand_holder_idiom).
 * 
...
public class MimeTypes implements FileNameMap {
    ...
    public static final MimeTypes getInstance(final Map<String, String> additionalMimeType) {
        ...
        Map<String, String> customized = new HashMap<String, String>(additionalMimeType.size() + mimeTypes.ressource.size());
