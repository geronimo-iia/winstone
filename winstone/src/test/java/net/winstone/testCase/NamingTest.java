...
public class NamingTest extends TestCase {
    ...
    public void setUp() throws NamingException {
        ...
        env.put(Context.INITIAL_CONTEXT_FACTORY, "winstone.jndi.java.javaURLContextFactory");
    ...
    public void testRelativeList() throws NamingException {
        NamingEnumeration<NameClassPair> listing = this.ic.list("");
    ...
    public void testAbsoluteList() throws NamingException {
        NamingEnumeration<NameClassPair> listing1 = this.ic.list("java:/comp/env");
        assertNotNull("Listing of java:/comp/env must be non-null", listing1);
        listing1.close();
        NamingEnumeration<NameClassPair> listing2 = this.ic.list("java:/comp/env/");
    ...
    public void testSimpleRebind() throws NamingException {
        ...
        Object lookupInt = this.ic.lookup("java:/comp/env/TestRebindContext/ChildRebind/integer");
        ...
        this.ic.rebind("TestRebindContext/ChildRebind/integer", new Integer(40));
        Object lookupInt2 = this.ic.lookup("TestRebindContext/ChildRebind/integer");
        ...
        Object lookupInt3 = this.ic.lookup("java:/comp/env/TestRebindContext/ChildRebind/integer");
        ...
        this.ic.destroySubcontext("java:/comp/env/TestRebindContext/ChildRebind");
