...
public class WebAppConfiguration implements ServletContext, Comparator<Object> {
     ...
     */
    public WebAppConfiguration(final HostConfiguration ownerHostConfig, final Cluster cluster, final JndiManager jndiManager,
            final String webRoot, final String prefix, final ObjectPool objectPool, final Map<String, String> startupArgs,
        ...
        if (!distributable && cluster != null) {
            WebAppConfiguration.logger.info("Clustering disabled for webapp {} - the web application must be distributable",
                    this.contextName);
            this.cluster = null;
        } else {
