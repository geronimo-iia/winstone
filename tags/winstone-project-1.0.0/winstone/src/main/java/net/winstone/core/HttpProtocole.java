...
/**
 * thanks to RISKO Gergely for the reason phrase patch borrowed from apache 2.2.6: % grep 100\ C -A 65 modules/http/http_protocol.c  | grep '^[[:space:]]*"' | cut -d\" -f2 | sed 's/^//;s/ /=/'
 *
